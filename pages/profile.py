...
# # Conditional Property Owner fields
# if property_owner == "Yes":
#     property_coords = st.text_input("Property Coordinates (Latitude, Longitude)", "32.7767, -96.7970")
#     square_footage = st.number_input("Square Footage of Property", min_value=0)
...
#         try:
#             lat_str, lon_str = property_coords.split(",")
...
#             st.error(f"Invalid coordinates. Use format: 32.7767, -96.7970\nError: {e}")
#     else:
#         st.session_state.property_owner = False
#         st.session_state.go_to_user_matches = True
...
# if st.session_state.get("go_to_user_matches"):
#     st.session_state.go_to_user_matches = False
#     st.switch_page("pages/users_matched.py")
...
if property_owner == "Yes":
    ...
    # Button for non-property owners
    if st.button("Risk Matches"):
        st.switch_page("pages/user_risk_match.py")
